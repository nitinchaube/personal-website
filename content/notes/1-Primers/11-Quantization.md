...
## 3) AWQ: protect the weights the activations care about
...
## 4) SmoothQuant: move the difficulty from activations to weights
...
## 5) OmniQuant: learn the clipping and the smoothing
