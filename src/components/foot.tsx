...
const Foot = () => {
  return (
    <footer className='pointer-events-auto relative z-20 flex flex-col items-center justify-center bg-secondary px-4 py-6 text-center text-text'>
      ...
      <a
        href={withBase('/tracker.html')}
        target='_blank'
        rel='noreferrer'
        className='mt-4 inline-flex items-center gap-1.5 rounded-full border border-text/30 px-4 py-1.5 text-[13px] font-medium text-text transition-all duration-200 hover:-translate-y-[2px] hover:border-primary hover:text-primary focus:-translate-y-[2px] focus:border-primary focus:text-primary'
      >
      ...
      <p className='mt-5 text-[14px] opacity-75 '>
        &copy; {new Date().getFullYear()} Thanks :) <br />
      </p>
      {/* <a
