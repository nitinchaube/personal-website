      ...
      <div className='paddingX absolute inset-0 top-[80px] mx-auto flex max-w-7xl flex-row items-start gap-5 xs:top-[120px] '>
        ...
        <div className='pointer-events-auto'>
          ...
          <motion.p
            ...
            animate='show'
          >
            I&apos;m an <span className='from-primary to-accent bg-clip-text text-transparent bg-gradient-120'>AI enthusiast & Computer Science Engineer</span> based in New Jersey&nbsp;
            ...
            <span className='hidden xs:inline landscape-sm:hidden'>
              , driven by a passion for intelligent systems&nbsp;
              <br className='hidden sm:block' />
              and always seeking exciting opportunities to innovate and grow.
            </span>
          </motion.p>
          <HeroSocial />
        </div>
