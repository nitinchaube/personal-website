      ...
      <div className='mx-auto flex w-full max-w-7xl select-none items-center justify-between'>
        ...
        >
          ...
          >
            ...
            <g transform="translate(0, 256) scale(0.0555, -0.0455)">
              {/* N Shape */}
              <path d="M600 5000 l0 -4500 400 0 400 0 1000 3000 0 -3000 400 0 400 0 0 4500 -400 0 -400 0 -1000 -3000 0 3000 -400 0 -400 0z" fill='currentColor' />
              {/* C Shape */}
              <path d="M3000 4900 c-600 -150 -1000 -800 -1000 -1740 0 -930 420 -1520 1100 -1580 310 -30 690 80 900 270 l60 55 -180 330 -60 -50 c-100 -85 -250 -135 -400 -135 -400 0 -660 370 -660 1080 0 720 250 1090 700 1090 170 0 330 -60 440 -170 l70 -70 170 320 -70 60 c-220 190 -660 280 -1070 230z" fill='currentColor'/>
            </g>
          </motion.svg>
