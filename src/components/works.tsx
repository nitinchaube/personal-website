    ...
    <>
      ...
      <div className='flex w-full'>
        <motion.p
          ...
          className='section-text pointer-events-auto mt-3 max-w-3xl text-[17px] leading-[30px] text-text'
        >
          I have three years of experience working in roles such as an AI Intern and Software Developer Analyst, where I gained hands-on exposure to building intelligent systems and scalable applications. My work bridges the gap between AI and software development, and I'm passionate about creating real-world solutions that have meaningful impact. I’ve also built several projects that showcase my ability to tackle diverse challenges, many of which include live demos and open-source repositories as proof of my skills and practical approach.
        </motion.p>
      </div>
